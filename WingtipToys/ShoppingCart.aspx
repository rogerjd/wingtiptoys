...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="CartList" runat="server" AutoGenerateColumns="false" ShowFooter="true" GridLines="Vertical" CellPadding="4"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Remove Total">
                <ItemTemplate>
                    <asp:CheckBox ID="Remove" Width="40" runat="server"></asp:CheckBox>
                </ItemTemplate>
            </asp:TemplateField>   
        </Columns>
    </asp:GridView>
    ...
    <table>
        <tr>
            <td>
                <asp:Button ID="UpdateBtn" Text="Update" runat="server" OnClick="UpdateBtn_Click"/>
            </td>
            <td>
